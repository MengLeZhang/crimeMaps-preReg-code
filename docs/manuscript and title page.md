...
## Ethics
This project has been approved by the University Research Ethics Committee at the University of Sheffield (approved 13/10/2021, reference no. 043654). The corresponding author submitted a University Research Ethics Committee-approved self-declaration to the ethics committee. This study involves no primary data collection or human participants. Most of the data we use was released in the public domain by the UK government or other public bodies. We have obtained consent from SYP to use their data which has been anonymised, and contains no personal information about offenders and victims. A full ethical review was waived by the University Ethics Committee since the research was judged to involve only existing data that has been robustly anonymised, and is unlikely to cause offence to those who originally provided the data. Our ethics approval letter is contained in the supplement (S4).
